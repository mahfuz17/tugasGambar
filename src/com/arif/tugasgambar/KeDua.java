...
public class KeDua extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ke_dua);
		...
		//setting input dalam huruf besar
		    ...
		    public void cekJawaban(View v){
				String jawabanBenar = "JEJAKA TAKUT";
				...
				if(jawabanUser.equals(jawabanBenar)){
					...
					Intent i = new Intent(getApplicationContext(), Ketiga.class);
					startActivity(i);
				}
				else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ke_dua, menu);
		return true;
	}
