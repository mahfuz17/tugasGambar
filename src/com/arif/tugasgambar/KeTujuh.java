...
public class KeTujuh extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_ke_tujuh);
		//Cari komponen edittext
			...
			public void cekJawaban(View v){
				...
				if(jawabanUser.equals(jawabanBenar)){
					...
					Intent i = new Intent(getApplicationContext(), Kedelapan.class);
					startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ke_tujuh, menu);
		return true;
	}
