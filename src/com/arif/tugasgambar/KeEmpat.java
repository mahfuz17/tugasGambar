...
public class KeEmpat extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ke_empat);
		//Cari komponen edittext
			...
			public void cekJawaban(View v){
				String jawabanBenar = "MEMUTAR LOGIKA";
				...
				if(jawabanUser.equals(jawabanBenar)){
					...
					Intent i = new Intent(getApplicationContext(), KeLima.class);
					startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ke_empat, menu);
		return true;
	}
