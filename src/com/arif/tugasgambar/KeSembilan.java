...
public class KeSembilan extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_ke_sembilan);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "IBRAHIM MOVICS";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), Kesepuluh.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ke_sembilan, menu);
		return true;
	}
